  ...
  return (
    <div className="px-3 mt-4 space-y-4 max-w-md mx-auto">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link to="/admin/publicacoes" className="p-4 rounded-xl border border-gray-200 bg-white shadow-sm text-center text-xs font-semibold text-gray-800">Publicações</Link>
